      ...
      <div className="container px-4 mx-auto">
        <div>
          <div className="max-w-2xl mx-auto mb-10 text-center">
            <h1 className="font-heading tracking-tight text-4xl  font-bold mb-4">
              Book Your Home Away from Home Today
            </h1>
            <p className="text-gray-500">We have the best hostels in OUI</p>
            {/* <p className="text-gray-500">
              However, with the right tools and strategies, it can be an easy
          ...
          <div className="flex flex-wrap -mx-4 -mb-16">
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-16">
              <div className="max-w-xs lg:px-4 mx-auto text-center">
                ...
                <div className="mt-3">
                  <h5 className="text-xl font-bold mb-1">Top-notch facility</h5>
                  <p className="text-lg text-gray-500">
                    Each hostel comes equipped with all the necessary facilities
                    every student needs to feel at home away from home.
                  </p>
                </div>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-16">
              <div className="max-w-xs lg:px-4 mx-auto text-center">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-lg text-gray-500">
                    Our Student team is made up of talented individuals with
                    experience from a wide range of industry sectors.
                  </p>
                </div>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-16">
              <div className="max-w-xs lg:px-4 mx-auto text-center">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-lg text-gray-500">
                    Little wonder we have a high customer satisfaction rate. We
                    are continuously seeking innovative ways to keep you happy.
                  </p>
                </div>
              </div>
            </div>
            {/* <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-16">
              <div className="max-w-xs lg:px-4 mx-auto text-center">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-lg text-gray-500">
                    We care for your well-being with dental and vision benefits.
                  </p>
                </div>
              </div>
            </div>
